...
$response = $this->context->getResponse();
  ...
  {
    $this->setDecoratorTemplate('' == 'layoutPrincipal' ? false : 'layoutPrincipal'.$this->getExtension());
  }
  $response->addHttpMeta('content-type', 'text/html', false);

  $response->addStylesheet('main.css', '', array ());
  $response->addStylesheet('base.css', '', array ());
  $response->addStylesheet('sistema.css', '', array ());
  $response->addStylesheet('menuh.css', '', array ());
