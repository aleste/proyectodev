...
abstract class BasesfGuardUserProfile extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfGuardUserProfilePeer';
	...
	public function setApellido($v)
	{
		...
		if ($this->apellido !== $v) {
			$this->apellido = $v;
			$this->modifiedColumns[] = sfGuardUserProfilePeer::APELLIDO;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(sfGuardUserProfilePeer::APELLIDO)) $criteria->add(sfGuardUserProfilePeer::APELLIDO, $this->apellido);
