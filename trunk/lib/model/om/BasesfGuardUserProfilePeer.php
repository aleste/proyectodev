...
abstract class BasesfGuardUserProfilePeer {
	...
	const APELLIDO = 'sf_guard_user_profile.APELLIDO';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'UserId', 'Apellido', 'Nombre', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'userId', 'apellido', 'nombre', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::USER_ID, self::APELLIDO, self::NOMBRE, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'user_id', 'apellido', 'nombre', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'UserId' => 1, 'Apellido' => 2, 'Nombre' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'userId' => 1, 'apellido' => 2, 'nombre' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::USER_ID => 1, self::APELLIDO => 2, self::NOMBRE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'user_id' => 1, 'apellido' => 2, 'nombre' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(sfGuardUserProfilePeer::APELLIDO);
...
//
// NOTE: This static code cannot call methods on the sfGuardUserProfilePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the sfGuardUserProfilePeer class:
//
// Propel::getDatabaseMap(sfGuardUserProfilePeer::DATABASE_NAME)->addTableBuilder(sfGuardUserProfilePeer::TABLE_NAME, sfGuardUserProfilePeer::getMapBuilder());
//
